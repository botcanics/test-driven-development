...
import org.tdd.junit.rules.RepeatRule;
 ...
 * @author John Blum
 * @see org.junit.Test
 * @see org.tdd.junit.Repeat
 * @see org.tdd.junit.rules.RepeatRule
 */
public class RepeatingTestCasesExampleTest {
  ...
  @Test
  @Repeat("tdd.example.test.case.with.non-existing.system.property")
  ...
  @Test
  @Repeat("tdd.example.test.case.two.repetitions")
